...
with open('students_project.csv') as f:
    ...
    letters = {student['name'][0] for student in students_with_grade}
    # print(letters)

    letter_names = {letter: [student['name'] for student in students if student['name'][0] == letter] for letter in letters }
    # print(letter_names)
    ...
    report = {
        ...
        "groups_by_first_letter": letter_names
